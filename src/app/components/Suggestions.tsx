    ...
    <div className="flex flex-col w-full overflow-y-scroll">
      ...
      <CustomTabPanel value={selectedTab} index={1}>
        <div className="flex flex-col w-full p-16 bg-slate-900">
          ...
          <p className="px-4 pb-2 pt-8 text-2xl font-semibold">Este es tu siguiente paso 🏃</p>
          <div className="flex flex-col w-full">
            <div className="flex flex-row gap-2 w-full overflow-scroll">
              {
                todas.map((recomendacion, index) => (
                  <div key={index} className="flex flex-col min-w-64 p-4 rounded-xl bg-slate-800 aspect-video">
